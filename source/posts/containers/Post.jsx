...
class Post extends Component {
	...
	async componentDidMount() {
		...
		const [user, comments] = await Promise.all([
			!this.props.user ? Api.users.getSingle(userId) : Promise.resolve(this.props.user),
			!this.props.comments ? Api.posts.getComments(id) : Promise.resolve(this.props.comments)
		]);
